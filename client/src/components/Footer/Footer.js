...
const Footer = () => {
  ...
  const leftSideItems = quantOfNavbaItems.length > 6 ? quantOfNavbaItems.slice(0, 4) : quantOfNavbaItems.slice(0, 3);
  const rightSideItems = quantOfNavbaItems.length > 6 ? quantOfNavbaItems.slice(4) : quantOfNavbaItems.slice(3);
